...
charts=(
  ...
  'lob1','a-repository-1','some-chart-a-repo1-5'
  'lob1','a-repository-1','some-chart-ab-repo1-6'
  'lob1','a-repository-1','some-chart-abc-repo1-7'
  'lob1','a-repository-1','some-chart-abcd-repo1-8'
  'lob1','a-repository-1','some-chart-abcde-repo1-9'
  ...
  'lob1','a-repository-abc-10','some-chart-repo10-1'
  'lob1','a-repository-abcdef-11','some-chart-repo11-1'
  'lob1','a-repository-abcdefghi-12','some-chart-repo12-1'
  'lob1','a-repository-abcdefghiklm-13','some-chart-repo13-1'
  'lob1','a-repository-abcdefghi-klmnop-14','some-chart-repo14-1'
  'lob1','a-repository-abcdefghik-lmnopqrs-15','some-chart-repo15-1'
  'lob1','a-repository-abcdefghiklmnop-qrstuv-16','some-chart-repo16-1'
  'lob1','a-repository-abcdefghiklmnop-qrstuvwxyz-17','some-chart-repo17-1'
...
versions=(
  ...
  'a-repository-1','some-chart-a-repo1-5','1.0.0','add389','feat(test): yet another message','2025-01-01T12:37:56Z'
  'a-repository-1','some-chart-ab-repo1-6','1.0.0','fed836','feat(test): yet another message','2025-01-01T12:37:56Z'
  'a-repository-1','some-chart-abc-repo1-7','1.0.0','ddd498','feat(test): yet another message','2025-01-01T12:37:56Z'
  'a-repository-1','some-chart-abcd-repo1-8','1.0.0','aff993','feat(test): yet another message','2025-01-01T12:37:56Z'
  'a-repository-1','some-chart-abcde-repo1-9','1.0.0','afd132','feat(test): yet another message','2025-01-01T12:37:56Z'
...
promotions=(
  ...
  'a-repository-1','some-chart-repo1-2','1.2.0','pre-alpha','2025-01-03T12:34:56Z'
  ...
  'a-repository-1','some-chart-a-repo1-5','1.0.0','pre-alpha','2025-01-01T12:37:59Z'
  'a-repository-1','some-chart-ab-repo1-6','1.0.0','pre-alpha','2025-01-01T12:37:59Z'
  'a-repository-1','some-chart-abc-repo1-7','1.0.0','pre-alpha','2025-01-01T12:37:59Z'
  'a-repository-1','some-chart-abcd-repo1-8','1.0.0','pre-alpha','2025-01-01T12:37:59Z'
  'a-repository-1','some-chart-abcde-repo1-9','1.0.0','pre-alpha','2025-01-01T12:37:59Z'
